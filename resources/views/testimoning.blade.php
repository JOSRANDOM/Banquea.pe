...
<section class="p-3 m-0 border-0 bd-example">
  <h1 class="text-3xl text-center font-bold mb-4">ALGUNOS TESTIMONIOS</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 justify-items-center">
        ...
        <div class="card bg-white/10 duration-500 lg:col-span-2 group-hover:scale-[0.85] hover:!scale-100 p-8 rounded-xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 justify-items-center">
        <div class="w-1/2 flex justify-center items-center lg:order-last">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 justify-items-center">
            ...
            <div class="w-full lg:w-auto mb-8 lg:col-span-2 lg:mb-0 lg:mr-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 justify-items-center">
            <div class="w-full lg:w-auto flex justify-center items-center lg:order-last">
            <img src="/image/carousel/SS.jpeg" alt="Image 1" style="max-width: 200px; height: auto; border-radius: 50%;">
            </div>
        <div class="w-full lg:w-auto lg:col-span-2 mb-8 lg:mb-0 lg:mr-8">
            <div class="card bg-white/10 duration-500 group-hover:scale-[0.85] hover:!scale-100 p-8 rounded-xl">
                <div class="mx-auto max-w-md lg:max-w-4xl">
